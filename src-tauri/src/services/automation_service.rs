...
pub enum TriggerType {
    Schedule { hour: u32, minute: u32, days: Vec<u32> },
    MonitorCount { count: i32 },
    Shortcut { key_combination: String },
}
...
impl AutomationService {
    pub async fn create_rule(
        ...
        let entity = repo.create(profile_uuid, &rule_type, trigger_config).await?;
    ...
    pub async fn toggle_rule(db: &Database, rule_id: &str, enabled: bool) -> Result<AutomationRuleDto> {
